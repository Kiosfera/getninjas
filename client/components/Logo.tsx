...
export default function Logo({ size = "md", variant = "full", className }: LogoProps) {
  ...
  const LogoIcon = () => (
    <div className={cn("relative rounded-2xl gradient-primary flex items-center justify-center shadow-soft", classes.icon)}>
  ...
  if (variant === "text-only") {
    return (
      <div className={cn("flex flex-col", className)}>
        <span className={cn("font-poppins font-bold text-foreground", classes.text)}>
          PANASERVICE
        </span>
        <span className={cn("font-montserrat font-medium text-muted-foreground -mt-1", classes.tagline)}>
  ...
  return (
    <div className={cn("flex items-center space-x-3", classes.container, className)}>
      <LogoIcon />
      <div className="flex flex-col">
        <span className={cn("font-poppins font-bold text-foreground leading-tight", classes.text)}>
          PANASERVICE
        </span>
        <span className={cn("font-montserrat font-medium text-muted-foreground leading-tight -mt-0.5", classes.tagline)}>
          todos os serviços em um só lugar
        </span>
      </div>
    </div>
