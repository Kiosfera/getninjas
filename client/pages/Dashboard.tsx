  ...
  return (
    <div className="min-h-screen bg-background pb-20">
      ...
      <section className="px-4 py-6">
        <h2 className="title-semibold text-lg text-foreground mb-4">
          Resumo - {currentMonth}
        </h2>
          ...
          <div className="bg-gradient-to-r from-primary to-primary-600 rounded-2xl p-4 text-white">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl title-bold">
                  R$ {dashboardStats.monthlyEarnings.toLocaleString()}
                </p>
              </div>
            ...
            >
              <div className="flex items-start justify-between mb-3">
                <div className="flex-1">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-primary title-semibold text-sm">
                      {request.budget}
                    </span>
                    {request.status === "new" ? (
                      <button
            ...
            >
              ...
              <div className="mb-3">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className="body-text text-xs text-foreground font-semibold">
                    {project.progress}%
                  </span>
                </div>
